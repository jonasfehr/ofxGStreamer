...
* [gstreamer-1.0-1.14.2-x86_64.pkg](https://gstreamer.freedesktop.org/data/pkg/osx/1.14.2/gstreamer-1.0-1.14.2-x86_64.pkg) installs the necesary libraries for applications to run

* [gstreamer-1.0-devel-1.14.2-x86_64.pkg](https://gstreamer.freedesktop.org/data/pkg/osx/1.14.2/gstreamer-1.0-devel-1.14.2-x86_64.pkg) installs the development files needed to compile gst applications

* [gstreamer-1.0-1.14.2-x86_64-packages.dmg](https://gstreamer.freedesktop.org/data/pkg/osx/1.14.2/gstreamer-1.0-1.14.2-x86_64-packages.dmg) contains some additional packages that are needed to encode some formats like h264, some of these packages have GPL license or use patented formats. Download the dmg and install the following packages from that collection:

This package is needed to do colorspace conversion:

    * gstreamer-1.0-libav-1.14.2-x86_64.pkg

And these packages will provide h264 encoding and some network utilities to stream h264 and other data formats:
    
    * gstreamer-1.0-codecs-restricted-1.14.2-x86_64.pkg
    
    * gstreamer-1.0-net-restricted-1.14.2-x86_64.pkg
...
Changes
2018-08-04    updated osx download links for libraries
